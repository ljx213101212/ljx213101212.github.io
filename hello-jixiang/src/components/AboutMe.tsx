...
const AboutMe = () => {
  return (
    <>
        ...
        <div className="md:flex justify-center flex-col flex-gold-after h-full">
          <div className="md:flex flex-col p-4 justify-items-center items-center">
            ...
            <p>
              ...
              engineering. He is specialized in frontend software development and delivered software applications
              through different platforms from Windows 10, Xbox and Web Browser. Working in an user && developer
              expereince oriented way.
            </p>
          </div>
      ...
      <div className="md:container md:mx-auto items-center px-4 my-12 lg: my-16 leading-normal">
        <section className="flex flex-col md:px-12 project">
